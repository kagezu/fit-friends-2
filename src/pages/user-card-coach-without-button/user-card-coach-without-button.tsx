export default function UserCardCoachWithoutButton(): JSX.Element {
  return (
    <>!{/*
                    ...
                    <div className="user-card-coach-2__card">
                      ...
                      <div className="user-card-coach-2__gallary">
                        <ul className="user-card-coach-2__gallary-list">
                          <li className="user-card-coach-2__gallary-item"><img src="img/content/user-coach-photo1.jpg" srcSet="img/content/user-coach-photo1@2x.jpg 2x" width="334" height="573" alt="photo1">
                          </li>
                          <li className="user-card-coach-2__gallary-item"><img src="img/content/user-coach-photo2.jpg" srcSet="img/content/user-coach-photo2@2x.jpg 2x" width="334" height="573" alt="photo2">
                          </li>
                        </ul>
                      </div>
                    </div>
